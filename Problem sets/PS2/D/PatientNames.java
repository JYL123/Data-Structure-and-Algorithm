...
class AVL
{
  ...
  protected int bf(AVLVertex T){
	...
	/*	else //if(v.equals(T.key))
		{
			System.out.println("Get the rank of 3 "+T.key);
			if(T.left!=null){
			//rank=T.left.size+1;
				System.out.println("Get the rank of 4 "+T.key);
...
class PatientNames {
  ...
  int Query(String START, String END, int gender) {
	    ...
	    if(gender==2)
	    {
	    	//System.out.println("START rank: "+TF.rank(START));
	    	//ans=TF.rank(endNode.key)-TF.rank(startNode.key)-1;
	    	//TF.inorder();
	    	
	    	//System.out.println("TF END rank: "+TF.rank(END));
	    	//System.out.println("TF START rank: "+TF.rank(START));
	    	ans=TF.rank(END)-TF.rank(START);
	    }
	    else if(gender==1)
	    {
	    	//System.out.println("TM END rank: "+TM.rank(END));
	    	//System.out.println("TM START rank: "+TM.rank(START));	     
